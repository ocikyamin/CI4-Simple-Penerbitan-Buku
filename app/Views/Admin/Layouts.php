...
<head>
    ...
    <script>
        ...
        let dataTable = new simpleDatatables.DataTable(tabel);
        });
    </script>
</head>
                ...
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            ...
                            <!-- <img src="<?=base_url()?>/logo.png" alt="Logo" srcset="">  -->
                            CV. Genzo</a>
                        </div>
                        <div class="toggler">
                    ...
                    <ul class="menu">                      
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/penerbitan/baru')?>"> Pengajuan Baru</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/penerbitan/list')?>">Data Penerbitan</a>
                                </li>
                            </ul>
                        </li>
                         <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul class="submenu" style="display: none;">
                                ...
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/anggota')?>"> Data Penulis</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/pembayaran')?>"> Data Pembayaran</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/penerbitan/list')?>"> Data Pengajuan</a>
                                </li>
                            </ul>
                        </li> 
                            <?php
                        ...
                        <!-- <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/laporan/buku')?>"> Data Buku</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/laporan/penulir')?>"> Data Penulis</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/laporan/penulir')?>"> Data Pembayaran</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="<?=base_url('admin/laporan/penulir')?>"> Data Pengajuan</a>
                                </li>
                            </ul>
                        </li> -->
